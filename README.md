...
gitGraph TB:
    ...
    commit
    switch dev
    merge feature-1 tag: "my_project/0.1.1-dev"
    switch main
    branch feature-2 order:3
    commit
    switch dev
    merge feature-3 tag: "my_project/0.1.2-dev"
    commit type: HIGHLIGHT id: "PR #5"
    switch feature-2
    commit
    commit
    switch main
    merge dev tag: "my_project/0.2.0"
    %% branch "dev'" order:1
    %% switch "dev'"
    switch dev
    merge main
    %% switch dev
    %% merge "dev'"
    branch feature-4 order:5
    commit
    commit
    commit id: "PR #7"
    switch dev
    merge feature-2 tag: "my_project/0.2.1-dev"
    merge feature-4 tag: "my_project/0.2.2-dev"
    commit type: HIGHLIGHT id: "PR #6"
    switch main
    merge dev tag: "my_project/0.3.0"
```
...
gitGraph TB:
    ...
    branch dev order:1
    branch feature-6 order:3
    commit
    commit
    commit
    branch feature-5 order:2
    commit
    commit
    switch feature-5
    commit type: HIGHLIGHT id: "PR #11"
    switch dev
    merge feature-5 tag: "my_project/0.9.1-dev"
    branch feature-8 order:5
    switch main
    branch feature-7 order:3
    commit
    switch feature-7
    commit type:HIGHLIGHT id: "PR #12"
    switch dev
    merge feature-7 tag: "my_project/0.9.2-dev"
    ...
    switch dev
    merge feature-6 tag: "my_project/0.10.1-dev"
    merge feature-8 tag: "my_project/0.10.2-dev"
